...
public class XG42Tessellator extends Tessellator {
    ...
    public static void prepare(int mode) {
        ...
        XG42Tessellator.begin(mode);
    }

    public static void drawEntityBox(AxisAlignedBB bb, int r, int g, int b, int a, int sides) {
        XG42Tessellator.drawEntityBox(INSTANCE.getBuffer(), bb, r, g, b, a, sides);
    }
    ...
    public static void drawTracer(Entity entity, float red, float green, float blue, float alpha, float width, float height) {
        ...
        Vec3d eyes = new Vec3d(0, 0, 1).rotatePitch(-(float) Math.toRadians(Wrapper.mc.player.rotationPitch)).rotateYaw(-(float) Math.toRadians(Wrapper.mc.player.rotationYaw));
    ...
    public static void drawFullBox(AxisAlignedBB bb, float width, int argb) {
        ...
        int g = argb >>> 8 & 255;
        int b = argb & 255;
        XG42Tessellator.drawFullBox(bb, width, r, g, b, a);
    }
    ...
    public static void drawBox(BlockPos blockPos, int argb, int sides) {
        ...
        int g = argb >>> 8 & 255;
        int b = argb & 255;
        XG42Tessellator.drawBox(blockPos, r, g, b, a, sides);
    }
    ...
    public static void drawBox(BlockPos blockPos, int r, int g, int b, int a, int sides) {
        XG42Tessellator.drawBox(INSTANCE.getBuffer(), blockPos.getX(), blockPos.getY(), blockPos.getZ(), 1.0f, 1.0f, 1.0f, r, g, b, a, sides);
    }
    ...
    public static void drawFace(BlockPos blockPos, int r, int g, int b, int a, int sides) {
        XG42Tessellator.drawFace(INSTANCE.getBuffer(), blockPos.getX(), blockPos.getY(), blockPos.getZ(), 1.0f, 1.0f, 1.0f, r, g, b, a, sides);
    }
    ...
    public static void drawFullBox(BlockPos pos, float width, int argb) {
        ...
        int g = argb >>> 8 & 255;
        int b = argb & 255;
        XG42Tessellator.drawFullBox(pos, width, r, g, b, a);
    }
    ...
    public static double calculateDistanceWithPartialTicks(final double n, final double n2, final float renderPartialTicks) {
        return n2 + (n - n2) * Wrapper.mc.getRenderPartialTicks();
    }
    ...
    public static void drawBoxOutline(BlockPos blockPos, int r, int g, int b, int a, int sides) {
        XG42Tessellator.drawBoxOutline(INSTANCE.getBuffer(), blockPos.getX(), blockPos.getY(), blockPos.getZ(), 1.0f, 1.0f, 1.0f, r, g, b, a, sides);
    }
    ...
    public static void drawLines(BlockPos blockPos, int r, int g, int b, int a, int sides) {
        XG42Tessellator.drawLines(INSTANCE.getBuffer(), blockPos.getX(), blockPos.getY(), blockPos.getZ(), 1.0f, 1.0f, 1.0f, r, g, b, a, sides);
    }
