...
public class HUDEditorScreen extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        XG42.getInstance().getHudEditor().drawScreen( mouseX,  mouseY,  partialTicks);
    }

    @Override
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        XG42.getInstance().getHudEditor(). mouseClicked( mouseX,  mouseY,  mouseButton);
    }

    @Override
    public void keyTyped(char typedChar, int keyCode) {
        XG42.getInstance().getHudEditor().keyTyped( typedChar,  keyCode);
    }

    @Override
    public void mouseReleased(int mouseX, int mouseY, int state) {
        XG42.getInstance().getHudEditor().mouseReleased( mouseX,  mouseY,  state);
    }
}
